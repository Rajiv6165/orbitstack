    ...
    <div className="min-h-screen bg-space-900 bg-stars flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="glass-card p-8">
          ...
          <p className="text-sm text-slate-500 mb-6">Join OrbitStack to start shopping</p>
          ...
          <p className="text-center text-sm text-slate-600 mt-6">
            ...
            <Link to="/login" className="text-orbital-400 hover:text-orbital-300 font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
